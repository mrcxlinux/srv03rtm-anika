...
rem seem to have race-condition issues in temp files, probably not setting correct mode when opening files or something
...
rem no matter what, it seems it can eventually error on some file
