...
rem eg. a call "fixexe.bat -i..\inc;..\rinc test.rc" becomes "msdos32 fixexe.16 -i..\inc ..\rinc test.rc" below, making fixexe treat ..\rinc as the input filename...
rem in the (rare?) instances of things using fixexe with ; or =, changing it to call msdos32 directly seems to fix it
...
rem no matter what, it seems fixexe will eventually error on some file
